		...
		<div class="col-12">
			<div class="card">
				<div class="card-body">
					...
					<?php
					echo form_open_multipart('userdata/edit2', 'role="form" class="form-horizontal"');
					?>
					<?php foreach ($rule as $r) { ?>
						...
						<?php
						echo form_open_multipart('userdata/edit22', 'role="form" class="form-horizontal"');
						?>
						<?php foreach ($rule2 as $r) { ?>
							...
							<?php
							echo form_open_multipart('userdata/edit3', 'role="form" class="form-horizontal"');
							?>
							<?php foreach ($rule3 as $r) { ?>
								...
								<?php
								echo form_open_multipart('userdata/edit4', 'role="form" class="form-horizontal"');
								?>
								<?php foreach ($rule4 as $r) { ?>
									...
									<?php
									echo form_open_multipart('userdata/edit5', 'role="form" class="form-horizontal"');
									?>
			...
			<div class="col-12">
				<div class="card">
					<div class="card-body">
						...
						<h5 class="card-title">Temperature</h5>
						<?php
						echo form_open_multipart('userdata/edit6', 'role="form" class="form-horizontal"');
						?>
						<?php foreach ($rule6 as $r) { ?>
							...
							<h5 class="card-title">PH</h5>
							<?php
							echo form_open_multipart('userdata/edit7', 'role="form" class="form-horizontal"');
							?>
							<?php foreach ($rule7 as $r) { ?>
								...
								<?php
								echo form_open_multipart('userdata/edit8', 'role="form" class="form-horizontal"');
								?>
								<?php foreach ($rule8 as $r) { ?>
									...
									<?php
									echo form_open_multipart('userdata/edit9', 'role="form" class="form-horizontal"');
									?>
			...
			<div class="col-11">
				<div class="card">
					<div class="card-body">
						...
						<?php
						echo form_open_multipart('userdata/edit10', 'role="form" class="form-horizontal"');
						?>
