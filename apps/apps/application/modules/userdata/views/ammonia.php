<div class="page-breadcrumb">
    <div class="row">
        <div class="col-7 align-self-center">
            <h2 class="page-title text-truncate text-dark font-weight-medium mb-1"> &nbsp; &nbsp; &nbsp; Indicator of Aquarium</h2>
...
?>
    <center>
        <?= anchor('userdata/datagrafik/' . $u->id_user, '<button type="button" class="btn btn-success text-center">Back to Parameter Device</button>'); ?>
    </center>
<?php } ?>
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    for (var i in data) {
                        ...
                        value.push(data[i].amoniak_akuarium);
