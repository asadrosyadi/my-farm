<div class="page-breadcrumb">
    <div class="row">
        <div class="col-7 align-self-center">
            <h2 class="page-title text-truncate text-dark font-weight-medium mb-1"> &nbsp; &nbsp; &nbsp; Monitoring Your Device</h2>
        ...
        <div class="col-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <center>
                        <?= anchor('historydevice/suhutanaman/' . $u->id_user, '<button type="button" class="btn btn-success text-center">Realtime Graph</button>'); ?>
                    </center>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    <div class="form-group" style="text-align:center;">
                        ...
                        <div <h1 class="small font-weight-bold">Light Intensity <span class="float-right"><?php echo $u->intentitascahaya_tanaman ?></span></h1>
                            ...
                            <?= anchor('historydevice/lightintensity/' . $u->id_user, '<h8 class="card-title">Realtime Graph</h8>'); ?>
                        </div>
                        ...
                        <div <h4 class="small font-weight-bold">Moisture <span class="float-right"><?php echo $u->kelembapan_tanaman ?></span></h4>
                            ...
                            <?= anchor('historydevice/moisture/' . $u->id_user, '<h8 class="card-title">Realtime Graph</h8>'); ?>
                        </div>
                        ...
                        <div <h4 class="small font-weight-bold">Minerals <span class="float-right"><?php echo $u->mineral_tanaman ?></span></h4>
                            ...
                            <?= anchor('historydevice/minerals/' . $u->id_user, '<h8 class="card-title">Realtime Graph</h8>'); ?>
                        </div>
        ...
        <div class="col-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <center>
                        <?= anchor('historydevice/co2tanaman/' . $u->id_user, '<button type="button" class="btn btn-success text-center">Realtime Graph</button>'); ?>
                    </center>
                </div>
            </div>
        </div>
        ...
        <div class="col-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <center>
                        <?= anchor('historydevice/o2tanaman/' . $u->id_user, '<button type="button" class="btn btn-success text-center">Realtime Graph</button>'); ?>
                    </center>
                </div>
            </div>
        </div>
        ...
        <div class="col-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <center>
                        <?= anchor('historydevice/discharge/' . $u->id_user, '<button type="button" class="btn btn-success text-center">Realtime Graph</button>'); ?>
                    </center>
                </div>
            </div>
        </div>
        ...
        <div class="col-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <center>
                        <?= anchor('historydevice/ph/' . $u->id_user, '<button type="button" class="btn btn-success text-center">Realtime Graph</button>'); ?>
                    </center>
                </div>
            </div>
        </div>
        ...
        <div class="col-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <center>
                        <?= anchor('historydevice/phakuarium/' . $u->id_user, '<button type="button" class="btn btn-success text-center">Realtime Graph</button>'); ?>
                    </center>
                </div>
            </div>
        </div>
        ...
        <div class="col-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <center>
                        <?= anchor('historydevice/suhuakuarium/' . $u->id_user, '<button type="button" class="btn btn-success text-center">Realtime Graph</button>'); ?>
                    </center>
                </div>
            </div>
        </div>
        ...
        <div class="col-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <center>
                        <?= anchor('historydevice/oxygen/' . $u->id_user, '<button type="button" class="btn btn-success text-center">Realtime Graph</button>'); ?>
                    </center>
                </div>
            </div>
        </div>
        ...
        <div class="col-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <center>
                        <?= anchor('historydevice/ammonia/' . $u->id_user, '<button type="button" class="btn btn-success text-center">Realtime Graph</button>'); ?>
                    </center>
                </div>
            </div>
        </div>
